			...
			GUILayout.BeginVertical(isSceneGUI ? InSceneWidth : CSG_GUIStyleUtility.ContentEmpty);
			{
				...
				GUILayout.BeginVertical(isSceneGUI ? GUI.skin.box : GUIStyle.none);
				{
					...
					{ 
						GUILayout.BeginHorizontal(CSG_GUIStyleUtility.ContentEmpty);
						{
							selectionIgnoreBackfaced = GUILayout.Toggle(selectionIgnoreBackfaced, "Ignore Hidden", button);
						}
						GUILayout.EndHorizontal();
						...
						GUILayout.BeginHorizontal(CSG_GUIStyleUtility.ContentEmpty);
						{
							selectionVertex		= GUILayout.Toggle(selectionVertex,		"Vertex",	button);
							selectionEdge		= GUILayout.Toggle(selectionEdge,		"Edge",		button);
							selectionSurface	= GUILayout.Toggle(selectionSurface,	"Surface",	button);
						}
						GUILayout.EndHorizontal();
					}
