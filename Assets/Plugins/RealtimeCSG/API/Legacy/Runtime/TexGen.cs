		...
		{
			{
				...
				scale.y =  Scale.y;
				scale.z = 1.0f;
				var scaleTranslationMatrix = Matrix4x4.TRS(Translation, Quaternion.identity, scale);
				var rotationMatrix = Matrix4x4.TRS(Vector3.zero, Quaternion.AngleAxis(RotationAngle, MathConstants.unitZVector3), Vector3.one);
				return scaleTranslationMatrix
						* rotationMatrix;
				#endif
			}
		}
